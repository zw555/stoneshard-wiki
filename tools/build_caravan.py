...
ZH_ROUTES = {
    ...
    "Ginger Root": ["布林青线商行（阿尔穆兹）", "野外采集"],
    "Spearmint": ["野外采集", "草药师 / 食物商贩"],
    "Leek": ["食物 / 蔬菜商贩", "野外采集"],
    "Garlic": ["食物 / 蔬菜商贩", "野外采集"],
    "Onion": ["食物 / 蔬菜商贩", "野外采集"],
    "Hieronite Altar": ["曼郡牧师乔什出售"],
    "Wax Candle": ["坟墓 / 地牢搜刮", "教会与杂货商人"],
    "Altar Bell": ["书架搜刮", "变节新徒（新教徒）地牢掉落"],
    "Lesser Runic Stone": ["布林码头矮人商人奥米（库存轮换）", "地牢搜刮"],
    "Candle-end": ["亡灵地牢内拾取"],
    ...
    "Hardy Tent Cloth": ["裁缝出售（完成小营帐后解锁：霍特 / 默里克）"],
    ...
    "Ironbound Chests": ["高级地牢搜刮", "木匠与商人处偶有出售"],
    "Foldable Flagpole": ["维伦（Verren）提供"],
    "Cage with Pigeons": ["杂货商人"],
